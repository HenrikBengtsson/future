...
> b
 b.pid b1.pid b2.pid 
  8548   8108   3488 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 8548) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 8108 and 3488).
...
> b
 b.pid b1.pid b2.pid 
  3488   8900   8888 
```
First, we see that both `a` and `b` are resolved in different processes (pids 8108 and 3488) than the calling process (pid 8548).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 8900 and 8888).
