...
> b
 b.pid b1.pid b2.pid 
  9744    584   9820 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 9744) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 584 and 9820).
...
> b
 b.pid b1.pid b2.pid 
  9820   8644   7420 
```
First, we see that both `a` and `b` are resolved in different processes (pids 584 and 9820) than the calling process (pid 9744).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 8644 and 7420).
