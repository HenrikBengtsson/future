...
> b
 ...
 27220  27321  27322 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 27220) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 27321 and 27322).
...
> b
 ...
 27324  27325  27327 
```
First, we see that both `a` and `b` are resolved in different processes (pids 27323 and 27324) than the calling process (pid 27220).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 27325 and 27327).
