...
> b
  b.pid b.1.pid b.2.pid 
   4364    7196    2852 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 4364) whereas the two nested futures (`b.1` and `b.2`) are resolved in two separate R processes (pids 7196 and 2852).
...
> b
  b.pid b.1.pid b.2.pid 
   2852    4644    7988 
```
First, we see that both `a` and `b` are resolved in different processes (pids 7196 and 2852) than the calling process (pid 4364).  Second, the two nested futures (`b.1` and `b.2`) are resolved in yet two other R processes (pids 4644 and 7988).
