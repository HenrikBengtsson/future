...
> b
 b.pid b1.pid b2.pid 
  6068   6134   6135 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 6068) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 6134 and 6135).
...
> b
 b.pid b1.pid b2.pid 
  6137   6138   6139 
```
First, we see that both `a` and `b` are resolved in different processes (pids 6136 and 6137) than the calling process (pid 6068).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 6138 and 6139).
