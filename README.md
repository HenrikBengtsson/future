...
Future 'b2' ...
 b.pid b1.pid b2.pid 
  4904   5028   5029 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 4904) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 5028 and 5029).
...
Future 'b2' ...
 b.pid b1.pid b2.pid 
  5031   5032   5033 
```
First, we see that both `a` and `b` are resolved in different processes (pids 5030 and 5031) than the calling process (pid 4904).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 5032 and 5033).
