...
> b
 ...
 31340  31430  31431 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 31340) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 31430 and 31431).
...
> b
 ...
 31433  31434  31435 
```
First, we see that both `a` and `b` are resolved in different processes (pids 31432 and 31433) than the calling process (pid 31340).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 31434 and 31435).
