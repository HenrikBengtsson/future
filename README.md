...
> b
  b.pid b.1.pid b.2.pid 
   7872    8072    5156 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 7872) whereas the two nested futures (`b.1` and `b.2`) are resolved in two separate R processes (pids 8072 and 5156).
...
> b
  b.pid b.1.pid b.2.pid 
   5156    3160    6132 
```
First, we see that both `a` and `b` are resolved in different processes (pids 8072 and 5156) than the calling process (pid 7872).  Second, the two nested futures (`b.1` and `b.2`) are resolved in yet two other R processes (pids 3160 and 6132).
