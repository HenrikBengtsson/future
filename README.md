...
> b
  b.pid b.1.pid b.2.pid 
   1368    2224    6652 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 1368) whereas the two nested futures (`b.1` and `b.2`) are resolved in two separate R processes (pids 2224 and 6652).
...
> b
  b.pid b.1.pid b.2.pid 
   6652    6428    1848 
```
First, we see that both `a` and `b` are resolved in different processes (pids 2224 and 6652) than the calling process (pid 1368).  Second, the two nested futures (`b.1` and `b.2`) are resolved in yet two other R processes (pids 6428 and 1848).
