...
> b
 b.pid b1.pid b2.pid 
  4516   4615   4616 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 4516) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 4615 and 4616).
...
> b
 b.pid b1.pid b2.pid 
  4618   4620   4621 
```
First, we see that both `a` and `b` are resolved in different processes (pids 4617 and 4618) than the calling process (pid 4516).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 4620 and 4621).
