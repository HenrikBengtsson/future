...
> b
 ...
 22420  22486  22487 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 22420) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 22486 and 22487).
...
> b
 ...
 22489  22490  22491 
```
First, we see that both `a` and `b` are resolved in different processes (pids 22488 and 22489) than the calling process (pid 22420).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 22490 and 22491).
