...
> b
 ...
 10604   8180  10836 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 10604) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 8180 and 10836).
...
> b
 ...
 10836  10212   1564 
```
First, we see that both `a` and `b` are resolved in different processes (pids 8180 and 10836) than the calling process (pid 10604).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 10212 and 1564).
