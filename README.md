...
> b
 ...
 20604  20791  20792 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 20604) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 20791 and 20792).
...
> b
 ...
 20794  20795  20796 
```
First, we see that both `a` and `b` are resolved in different processes (pids 20793 and 20794) than the calling process (pid 20604).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 20795 and 20796).
