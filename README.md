...
> b
 b.pid b1.pid b2.pid 
  1828   6892   2860 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 1828) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 6892 and 2860).
...
> b
 b.pid b1.pid b2.pid 
  2860   5220   5512 
```
First, we see that both `a` and `b` are resolved in different processes (pids 6892 and 2860) than the calling process (pid 1828).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 5220 and 5512).
