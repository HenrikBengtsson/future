...
> b
 ...
 23292  23381  23382 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 23292) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 23381 and 23382).
...
> b
 ...
 23384  23385  23387 
```
First, we see that both `a` and `b` are resolved in different processes (pids 23383 and 23384) than the calling process (pid 23292).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 23385 and 23387).
