...
> b
 ...
 12461  12555  12556 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 12461) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 12555 and 12556).
...
> b
 ...
 12558  12559  12560 
```
First, we see that both `a` and `b` are resolved in different processes (pids 12557 and 12558) than the calling process (pid 12461).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 12559 and 12560).
