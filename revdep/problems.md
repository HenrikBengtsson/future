...
*   checking tests ...
    ...
    Last 13 lines of output:
      [19:50:51.747] - success
      [19:50:51.747] Attempting to find a working pid_exists_*() function ... done
      Worker (PID 31251) was successfully killed: TRUE
       ...
       * Worker launch call: '/usr/lib/R/bin/Rscript' --default-packages=datasets,utils,grDevices,graphics,stats,methods -e '#label=doRNG,dopar.R:31058:hb-x1:hb' -e 'try(suppressWarnings(cat(Sys.getpid(),file="/tmp/hb/RtmpLEAys7/future.parent=31058.79525759953f.pid")), silent = TRUE)' -e 'parallel:::.slaveRSOCK()' MASTER=localhost PORT=37752 OUT=/dev/null TIMEOUT=120 XDR=TRUE.
       * Worker (PID 31251) was successfully killed: TRUE
