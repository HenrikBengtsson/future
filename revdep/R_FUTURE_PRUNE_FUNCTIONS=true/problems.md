...
*   checking tests ...
    ...
    Last 50 lines of output:
      [20:04:56.233] Early signaling: FALSE
    ...
      [20:04:56.609] Early signaling: FALSE
      [20:04:56.609] Owner process: 91944ee3-07b1-8111-3991-56bd106cac2f
      [20:04:56.609] Class: 'MultisessionFuture', 'ClusterFuture', 'MultiprocessFuture', 'Future', 'environment'
      [20:04:56.623] Chunk #2 of 2 ... DONE
      [20:04:56.624] Launching 2 futures (chunks) ... DONE
      [20:04:56.624] Resolving 2 futures (chunks) ...
...
*   checking tests ...
    ```
      Running ‘testthat.R’/software/c4/cbi/software/R-4.2.0-gcc10/lib64/R/bin/BATCH: line 60: 104136 Aborted                 (core dumped) ${R_HOME}/bin/R -f ${in} ${opts} ${R_BATCH_OPTIONS} > ${out} 2>&1
