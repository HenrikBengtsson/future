...
*   checking tests ...
    ...
    ...
      ...
      [ FAIL 5 | WARN 17 | SKIP 0 | PASS 248 ]
      Error: Test failures
      Execution halted
    ```
...
*   checking tests ...
    ...
    ...
      ...
      [ FAIL 36 | WARN 0 | SKIP 6 | PASS 416 ]
      Error: Test failures
      Execution halted
    ```
...
*   checking tests ...
    ...
    Last 50 lines of output:
      ...
      Error in `get(library$library$predAlgorithm[s], envir = env)`: object 'SL.glm' not found
      Backtrace:
    ...
        6.         ├─future::value(fs)
      ...
      [ FAIL 4 | WARN 39 | SKIP 0 | PASS 1007 ]
      Error: Test failures
      Execution halted
    ```
...
*   checking tests ...
    ...
    Complete output:
      ...
      > 
      > test_check("gtfs2gps")
      [ FAIL 2 | WARN 6 | SKIP 0 | PASS 152 ]
      
    ...
      Error in `eval_bare(expr, quo_get_env(quo))`: object '.N' not found
      Backtrace:
          ▆
...
*   checking re-building of vignette outputs ... WARNING
    ```
    Error(s) in re-building vignettes:
    --- re-building ‘AfterFitting.Rmd’ using rmarkdown
    --- finished re-building ‘AfterFitting.Rmd’
    ...
    --- re-building ‘SelectingParameters.Rmd’ using rmarkdown
    --- finished re-building ‘SelectingParameters.Rmd’
...
*   checking tests ...
    ...
    ...
      ...
      Backtrace:
          ▆
       1. ├─base::suppressWarnings(...) at test-utils.R:60:2
       2. │ └─base::withCallingHandlers(...)
       3. └─seq_len(samples) %>% ... at test-utils.R:61:4
...
*   checking tests ...
    ...
    Last 50 lines of output:
        ...
        7.           ├─future::run(future)
        8.           └─future:::run.ClusterFuture(future)
        9.             └─future:::cluster_call(cl, fun = grmall, future = future, when = "call grmall() on")
    ...
        9.             └─future:::run.ClusterFuture(future)
       10.               └─future:::cluster_call(cl, fun = grmall, future = future, when = "call grmall() on")
       11.                 └─base::tryCatch(...)
       12.                   └─base tryCatchList(expr, classes, parentenv, handlers)
       13.                     └─base tryCatchOne(expr, names, parentenv, handlers[[1L]])
       14.                       └─value[[3L]](cond)
      
      [ FAIL 6 | WARN 0 | SKIP 0 | PASS 465 ]
      Error: Test failures
      Execution halted
    ```
...
*   checking tests ...
    ...
    Complete output:
      ...
      > 
      > test_check("Seurat")
      [ FAIL 1 | WARN 4 | SKIP 19 | PASS 594 ]
    ...
...
* Date/Publication: 2022-01-04 15:30:05 UTC
...
*   checking re-building of vignette outputs ... WARNING
    ...
    Error(s) in re-building vignettes:
      ...
    --- re-building ‘XNAString_vignette.Rmd’ using knitr
    Quitting from lines 499-513 (XNAString_vignette.Rmd) 
    Error: processing vignette 'XNAString_vignette.Rmd' failed with diagnostics:
    object 'compl_dict' not found
