...
#'
#'  \item{\option{future.availableCores.custom}:}{If set and a function, then this function will be called (without arguments) by \code{\link{availableCores}()} where its value being interpreted as a number of cores.}
#'
