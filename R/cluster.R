...
#'
#' @export
cluster <- function(expr, envir=parent.frame(), substitute=TRUE, globals=TRUE, persistent=FALSE, workers=NULL, user=NULL, reverseTunnel=TRUE, homogeneous=TRUE, gc=FALSE, earlySignal=FALSE, ...) {
